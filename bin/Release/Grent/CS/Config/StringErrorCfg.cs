...
public class StringErrorTable
{
  ...
  public List<StringErrorElement> GetAllElement(Predicate<StringErrorElement> matchCB = null)
	...
	public bool LoadBin(byte[] binContent)
	{
		...
		if(vecLine[2]!="comment"){Ex.Logger.Log("StringError.csv中字段[comment]位置不对应"); return false; }
		if(vecLine[3]!="sc"){Ex.Logger.Log("StringError.csv中字段[sc]位置不对应"); return false; }
