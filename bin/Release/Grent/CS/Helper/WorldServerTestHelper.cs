...
[System.Serializable]
public class WorldServerRpcPlayCgTeamAskWraperHelper
{
...
public class WorldServerTestHelper : MonoBehaviour
{
	...
	public WorldServerRpcPlayCgTeamAskWraperHelper WorldServerRpcPlayCgTeamAskWraperVar;
	...
	{
		WorldServerRPC.Instance.CreateDungeonNotify(WorldServerRpcCreateDungeonNotifyAskWraperVar.CurSceneId,WorldServerRpcCreateDungeonNotifyAskWraperVar.RoleId,WorldServerRpcCreateDungeonNotifyAskWraperVar.TargetSceneId,delegate(object obj){});
	}
	...
	{
		WorldServerRPC.Instance.UpdateTeamInfo(WorldServerRpcUpdateTeamInfoAskWraperVar.TeamMember,WorldServerRpcUpdateTeamInfoAskWraperVar.RoleId,WorldServerRpcUpdateTeamInfoAskWraperVar.Team,WorldServerRpcUpdateTeamInfoAskWraperVar.TeamType,delegate(object obj){});
	}
	public void TestPlayCgTeam()
	{
		WorldServerRPC.Instance.PlayCgTeam(WorldServerRpcPlayCgTeamAskWraperVar.PlayRoleId,WorldServerRpcPlayCgTeamAskWraperVar.CgId,WorldServerRpcPlayCgTeamAskWraperVar.State,WorldServerRpcPlayCgTeamAskWraperVar.RoleId,delegate(object obj){});
	}
	public void TestSendMail()
	{
		WorldServerRPC.Instance.SendMail(WorldServerRpcSendMailAskWraperVar.Mail,WorldServerRpcSendMailAskWraperVar.GlobalMailID,delegate(object obj){});
	}
	public void TestChangeTeamType()
	{
		WorldServerRPC.Instance.ChangeTeamType(WorldServerRpcChangeTeamTypeAskWraperVar.TeamId,WorldServerRpcChangeTeamTypeAskWraperVar.RoleId,WorldServerRpcChangeTeamTypeAskWraperVar.Result,WorldServerRpcChangeTeamTypeAskWraperVar.TeamType,WorldServerRpcChangeTeamTypeAskWraperVar.Target,delegate(object obj){});
	}
	public void TestAutoMatch()
	{
		WorldServerRPC.Instance.AutoMatch(WorldServerRpcAutoMatchAskWraperVar.MemberInfo,WorldServerRpcAutoMatchAskWraperVar.MatchInfo,WorldServerRpcAutoMatchAskWraperVar.Result,delegate(object obj){});
	}
	public void TestCancelMatch()
	{
		WorldServerRPC.Instance.CancelMatch(WorldServerRpcCancelMatchAskWraperVar.RoleId,WorldServerRpcCancelMatchAskWraperVar.Result,WorldServerRpcCancelMatchAskWraperVar.IsNotify,delegate(object obj){});
	}
	public void TestLoginGameServer()
	{
		WorldServerRPC.Instance.LoginGameServer(WorldServerRpcLoginGameServerAskWraperVar.Team,WorldServerRpcLoginGameServerAskWraperVar.RoleInfo,WorldServerRpcLoginGameServerAskWraperVar.Location,delegate(object obj){});
	}
	public void TestLogoutGameServer()
	{
		WorldServerRPC.Instance.LogoutGameServer(WorldServerRpcLogoutGameServerAskWraperVar.Result,WorldServerRpcLogoutGameServerAskWraperVar.RoleInfo,delegate(object obj){});
	}
	public void TestGetPlayerInfo()
	{
		WorldServerRPC.Instance.GetPlayerInfo(WorldServerRpcGetPlayerInfoAskWraperVar.Player_guid,delegate(object obj){});
	}
...
public class WorldServerTester : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		if (GUILayout.Button("PlayCgTeam"))
		{
			WorldServerTestHelper rpc = target as WorldServerTestHelper;
			if( rpc ) rpc.TestPlayCgTeam();
		}
