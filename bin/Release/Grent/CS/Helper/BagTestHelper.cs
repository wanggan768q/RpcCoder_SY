...
public class BagTestHelper : MonoBehaviour
{
	...
	{
		BagRPC.Instance.UseItem(BagRpcUseItemAskWraperVar.Count,BagRpcUseItemAskWraperVar.Pos,BagRpcUseItemAskWraperVar.BagType,delegate(object obj){});
	}
	...
	{
		BagRPC.Instance.ConsumeItem(BagRpcConsumeItemAskWraperVar.ConfigId,BagRpcConsumeItemAskWraperVar.ItemData,delegate(object obj){});
	}
