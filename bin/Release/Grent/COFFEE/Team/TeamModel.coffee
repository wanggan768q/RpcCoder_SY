...
class TeamModel
  ...
  SummonMember : (replyCB) ->
    ...
    NetTipController.showNetTip()
  ChangeTeamTarget : (TargetType,Id,MinLevel,MaxLevel,Function,replyCB) ->
    ChangeTeamTargetAsk = ChangeTeamTargetAskPB.prototype
    ChangeTeamTargetAsk.setTargetType TargetType
    ChangeTeamTargetAsk.setId Id
    ChangeTeamTargetAsk.setMinLevel MinLevel
    ChangeTeamTargetAsk.setMaxLevel MaxLevel
    ChangeTeamTargetAsk.setFunction Function
  ...
  GetCoffeeInfo: ->
      ...
      'ParamterList': [[],
                       ...
                       ["FollowTeamLeader"],
                       [],
                       ["TargetType","Id","MinLevel","MaxLevel","Function"],
                       ["TeamType"],
                       ["RoleId"],
                       ["TeamId","IsLeader"],
                       ["RoleId"],
