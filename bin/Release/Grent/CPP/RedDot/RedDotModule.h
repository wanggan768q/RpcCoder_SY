...
#ifndef __MODULE_REDDOT_H
#define __MODULE_REDDOT_H


#include "ModuleBase.h"
#include "RedDotRpcWraper.h"




//红点系统实现类
class ModuleRedDot : public ModuleBase
{
	DECLARE_INSTANCE(ModuleRedDot);
public:
...
public:
	...
	********************************************************************************************/
	static int RpcSyncRedDot( CPlayer* pPlayer, CPacket* pPacket );
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	static int RpcRemoveRedDot( CPlayer* pPlayer, CPacket* pPacket );
	...
	* Return:         无
	********************************************************************************************/
	//virtual void SendToClientUpdateRedDot( INT64 UserId, RedDotRpcUpdateRedDotNotifyWraper& Notify );
