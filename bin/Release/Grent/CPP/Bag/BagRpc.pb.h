...
class BagRpcConsumeItemAsk : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 configid(int index) const;
  inline void set_configid(int index, ::google::protobuf::int32 value);
  inline void add_configid(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > configid_;
...
// repeated int32 ConfigId = 1;
inline int BagRpcConsumeItemAsk::configid_size() const {
  return configid_.size();
}
inline void BagRpcConsumeItemAsk::clear_configid() {
  configid_.Clear();
}
inline ::google::protobuf::int32 BagRpcConsumeItemAsk::configid(int index) const {
  return configid_.Get(index);
}
inline void BagRpcConsumeItemAsk::set_configid(int index, ::google::protobuf::int32 value) {
  configid_.Set(index, value);
}
inline void BagRpcConsumeItemAsk::add_configid(::google::protobuf::int32 value) {
  configid_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
BagRpcConsumeItemAsk::configid() const {
  return configid_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
BagRpcConsumeItemAsk::mutable_configid() {
  return &configid_;
}
