...
//MergeItem回应封装类
class BagRpcMergeItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//背包数据初始化请求封装类
class BagRpcBagSyncAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//背包数据初始化回应封装类
class BagRpcBagSyncReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//临时背包全部取回回应封装类
class BagRpcTakeAllBackBagsReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//背包数据推送通知封装类
class BagRpcBagChangeNotifyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//MergeItem请求封装类
class BagRpcMergeItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//物品改变通知封装类
class BagRpcItemChangeNotifyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//点击物品请求封装类
class BagRpcClickItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//点击物品回应封装类
class BagRpcClickItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//新加物品通知封装类
class BagRpcAddItemNotifyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//根据物品id使用物品请求封装类
class BagRpcConsumeItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
	...
	BagRpcConsumeItemAsk ToPB() const
	{
		...
		v.mutable_configid()->Reserve(m_ConfigId.size());
		for (int i=0; i<(int)m_ConfigId.size(); i++)
		{
			v.add_configid(m_ConfigId[i]);
		}
...
private:
	...
	{
		m_ConfigId.clear();
		m_ConfigId.reserve(v.configid_size());
		for( int i=0; i<v.configid_size(); i++)
			m_ConfigId.push_back(v.configid(i));
		m_ItemData.clear();
...
private:
	//物品id
	vector<INT32> m_ConfigId;
public:
	int SizeConfigId()
	{
		return m_ConfigId.size();
	}
	const vector<INT32>& GetConfigId() const
	{
		return m_ConfigId;
	}
	INT32 GetConfigId(int Index) const
	{
		if(Index<0 || Index>=(int)m_ConfigId.size())
		{
			assert(false);
			return INT32();
		}
	...
	void SetConfigId( const vector<INT32>& v )
	{
		m_ConfigId=v;
	}
	void ClearConfigId( )
	...
	void SetConfigId( int Index, INT32 v )
	{
		if(Index<0 || Index>=(int)m_ConfigId.size())
		{
			assert(false);
	...
	void AddConfigId( INT32 v = -1 )
	{
		m_ConfigId.push_back(v);
	}
private:
	//物品id
...
//根据物品id使用物品回应封装类
class BagRpcConsumeItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//临时背包全部取回请求封装类
class BagRpcTakeAllBackBagsAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//SaleItem回应封装类
class BagRpcSaleItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//LockItem请求封装类
class BagRpcLockItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//LockItem回应封装类
class BagRpcLockItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//UseItem请求封装类
class BagRpcUseItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//UseItem回应封装类
class BagRpcUseItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//SaleItem请求封装类
class BagRpcSaleItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//TakeItem回应封装类
class BagRpcTakeItemReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//整理请求封装类
class BagRpcTidyAskWraper : public DataWraperInterface 
{
public:
	//构造函数
	BagRpcTidyAskWraper()
...
//整理回应封装类
class BagRpcTidyReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//解锁背包格子请求封装类
class BagRpcDeblockingAskWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//解锁背包格子回应封装类
class BagRpcDeblockingReplyWraper : public DataWraperInterface 
{
public:
	//构造函数
...
//TakeItem请求封装类
class BagRpcTakeItemAskWraper : public DataWraperInterface 
{
public:
	//构造函数
