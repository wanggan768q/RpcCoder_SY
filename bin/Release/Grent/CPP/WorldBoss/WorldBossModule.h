...
#ifndef __MODULE_WORLDBOSS_H
#define __MODULE_WORLDBOSS_H


#include "ModuleBase.h"
#include "WorldBossRpcWraper.h"




//世界BOSS模块实现类
class ModuleWorldBoss : public ModuleBase
{
	DECLARE_INSTANCE(ModuleWorldBoss);
public:
...
public:
	...
	********************************************************************************************/
	static int RpcWorldBossInfo( CPlayer* pPlayer, CPacket* pPacket );
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	static int RpcWorldBossRankInfo( CPlayer* pPlayer, CPacket* pPacket );
