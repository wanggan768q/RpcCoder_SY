...
* FileName:     ModuleExpressionAction.h
* Author:       甘业清
...
#ifndef __MODULE_EXPRESSIONACTION_H
#define __MODULE_EXPRESSIONACTION_H


#include "ModuleBase.h"
#include "ExpressionActionRpcWraper.h"




//表情动作实现类
class ModuleExpressionAction : public ModuleBase
{
	DECLARE_INSTANCE(ModuleExpressionAction);
public:
	friend class			ModuleMgr;

public:
	//表情动作实现类构造函数
	ModuleExpressionAction();
	
	//表情动作实现类析构函数
	virtual					~ModuleExpressionAction();
...
public:
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	static int RpcSetWheel( CPlayer* pPlayer, CPacket* pPacket );
	...
	*                     低16位为操作返回值，获取方法GET_OPERATION_RET_CODE(ret)
	********************************************************************************************/
	static int RpcUseAction( CPlayer* pPlayer, CPacket* pPacket );
	...
	* Return:         无
	********************************************************************************************/
	//virtual void SendToClientUseActionNotify( INT64 UserId, ExpressionActionRpcUseActionNotifyNotifyWraper& Notify );
