...
[System.Serializable]
public class SceneRpcDayNightChangeNotifyWraperHelper
{
	public int DayStage;
	public int Remaining;
}
[System.Serializable]
public class SceneRpcWeatherChangeNotifyWraperHelper
{
	public int WeatherId;
}
[System.Serializable]
public class SceneRpcWantChangeZoneAskWraperHelper
{
	public int Zoneid;
}
[System.Serializable]
public class SceneRpcReturnSrcServerAskWraperHelper
{
}
...
public class SceneTestHelper : MonoBehaviour
{
	...
	public SceneRpcDayNightChangeNotifyWraperHelper SceneRpcDayNightChangeNotifyWraperVar;
	public SceneRpcWeatherChangeNotifyWraperHelper SceneRpcWeatherChangeNotifyWraperVar;
	public SceneRpcWantChangeZoneAskWraperHelper SceneRpcWantChangeZoneAskWraperVar;
	public SceneRpcReturnSrcServerAskWraperHelper SceneRpcReturnSrcServerAskWraperVar;
	...
	{
		SceneRPC.Instance.ConnectGameServer(SceneRpcConnectGameServerAskWraperVar.RoleId,SceneRpcConnectGameServerAskWraperVar.Key,SceneRpcConnectGameServerAskWraperVar.SceneID,SceneRpcConnectGameServerAskWraperVar.LineID,SceneRpcConnectGameServerAskWraperVar.GameToken,delegate(object obj){});
	}
	...
	public void TestWantChangeZone()
	{
		SceneRPC.Instance.WantChangeZone(SceneRpcWantChangeZoneAskWraperVar.Zoneid,delegate(object obj){});
	}
	public void TestReturnSrcServer()
	{
		SceneRPC.Instance.ReturnSrcServer(delegate(object obj){});
	}
...
public class SceneTester : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		if (GUILayout.Button("WantChangeZone"))
		{
			SceneTestHelper rpc = target as SceneTestHelper;
			if( rpc ) rpc.TestWantChangeZone();
		}
		if (GUILayout.Button("ReturnSrcServer"))
		{
			SceneTestHelper rpc = target as SceneTestHelper;
			if( rpc ) rpc.TestReturnSrcServer();
		}
