...
public class WorldServerRPC
{
	...
	public const int RPC_CODE_WORLDSERVER_CREATEDUNGEONNOTIFY_REQUEST = 851;
	public const int RPC_CODE_WORLDSERVER_EXITDUNGEON_REQUEST = 852;
	public const int RPC_CODE_WORLDSERVER_UPDATETEAMINFO_REQUEST = 853;
	public const int RPC_CODE_WORLDSERVER_SENDMAIL_REQUEST = 854;
	public const int RPC_CODE_WORLDSERVER_CHANGETEAMTYPE_REQUEST = 855;
	public const int RPC_CODE_WORLDSERVER_AUTOMATCH_REQUEST = 856;
	public const int RPC_CODE_WORLDSERVER_CANCELMATCH_REQUEST = 857;
	public const int RPC_CODE_WORLDSERVER_LOGINGAMESERVER_REQUEST = 858;
	public const int RPC_CODE_WORLDSERVER_LOGOUTGAMESERVER_REQUEST = 859;
	public const int RPC_CODE_WORLDSERVER_GETPLAYERINFO_REQUEST = 860;
	...
	*世界服务器模块-->登录服务器 RPC请求
	*/
	public void LoginGameServer(TeamInfoWraper Team, OnlineUserInfoWraper RoleInfo, CharacterLocationWraper Location, int GateId, ReplyHandler replyCB)
	{
