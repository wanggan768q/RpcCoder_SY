...
public class BagRpcUseItemAskWraper
{
	...
	//自选礼包的索引
	public int m_OptionIdx;
	public int OptionIdx
	{
		get { return m_OptionIdx;}
		set { m_OptionIdx = value; }
	}
...
//通过位置删除物品请求封装类
[System.Serializable]
public class BagRpcRemoveItemByPosAskWraper
{

	//构造函数
	public BagRpcRemoveItemByPosAskWraper()
	{
		m_PosList = new List<int>();
		 m_BagType = -1;
	...
	public void ResetWraper()
	{
 	...
 	//转化成Protobuffer类型函数
	public BagRpcRemoveItemByPosAsk ToPB()
	{
		BagRpcRemoveItemByPosAsk v = new BagRpcRemoveItemByPosAsk();
		for (int i=0; i<(int)m_PosList.Count; i++)
			v.PosList.Add( m_PosList[i]);
		v.BagType = m_BagType;
	...
	//从Protobuffer类型初始化
	public void FromPB(BagRpcRemoveItemByPosAsk v)
	{
        if (v == null)
            return;
		m_PosList.Clear();
		for( int i=0; i<v.PosList.Count; i++)
			m_PosList.Add(v.PosList[i]);
		m_BagType = v.BagType;
	...
	{
		MemoryStream protoMS = new MemoryStream();
		ProtoBuf.Serializer.Serialize<BagRpcRemoveItemByPosAsk>(protoMS, ToPB());
		return protoMS;
	}
	...
	public bool FromMemoryStream(MemoryStream protoMS)
	{
		BagRpcRemoveItemByPosAsk pb = ProtoBuf.Serializer.Deserialize<BagRpcRemoveItemByPosAsk>(protoMS);
		FromPB(pb);
		return true;
	}
	...
	public void SetPosList( List<int> v )
	{
		m_PosList=v;
	}
	public void SetPosList( int Index, int v )
	{
		if(Index<0 || Index>=(int)m_PosList.Count)
			return;
		m_PosList[Index] = v;
	}
	public void AddPosList( int v=-1 )
	{
		m_PosList.Add(v);
	}
...
//通过位置删除物品回应封装类
[System.Serializable]
public class BagRpcRemoveItemByPosReplyWraper
{

	//构造函数
	public BagRpcRemoveItemByPosReplyWraper()
	{
		 m_Result = -1;
		m_ItemList = new List<ItemObjWraper>();
	...
	public void ResetWraper()
	{
 	...
 	//转化成Protobuffer类型函数
	public BagRpcRemoveItemByPosReply ToPB()
	{
		BagRpcRemoveItemByPosReply v = new BagRpcRemoveItemByPosReply();
		v.Result = m_Result;
		for (int i=0; i<(int)m_ItemList.Count; i++)
			v.ItemList.Add( m_ItemList[i].ToPB());
	...
	//从Protobuffer类型初始化
	public void FromPB(BagRpcRemoveItemByPosReply v)
	{
        if (v == null)
            return;
		m_Result = v.Result;
	...
	{
		MemoryStream protoMS = new MemoryStream();
		ProtoBuf.Serializer.Serialize<BagRpcRemoveItemByPosReply>(protoMS, ToPB());
		return protoMS;
	}
	...
	public bool FromMemoryStream(MemoryStream protoMS)
	{
		BagRpcRemoveItemByPosReply pb = ProtoBuf.Serializer.Deserialize<BagRpcRemoveItemByPosReply>(protoMS);
		FromPB(pb);
		return true;
	}
...
//清除背包红点请求封装类
[System.Serializable]
public class BagRpcClearBagRedPointAskWraper
{

	//构造函数
	public BagRpcClearBagRedPointAskWraper()
	{
	...
	public void ResetWraper()
	{
 	...
 	//转化成Protobuffer类型函数
	public BagRpcClearBagRedPointAsk ToPB()
	{
		BagRpcClearBagRedPointAsk v = new BagRpcClearBagRedPointAsk();

		return v;
	}
	
	//从Protobuffer类型初始化
	public void FromPB(BagRpcClearBagRedPointAsk v)
	{
        if (v == null)
            return;
	...
	{
		MemoryStream protoMS = new MemoryStream();
		ProtoBuf.Serializer.Serialize<BagRpcClearBagRedPointAsk>(protoMS, ToPB());
		return protoMS;
	}
	...
	public bool FromMemoryStream(MemoryStream protoMS)
	{
		BagRpcClearBagRedPointAsk pb = ProtoBuf.Serializer.Deserialize<BagRpcClearBagRedPointAsk>(protoMS);
		FromPB(pb);
		return true;
	}
...
//清除背包红点回应封装类
[System.Serializable]
public class BagRpcClearBagRedPointReplyWraper
{

	//构造函数
	public BagRpcClearBagRedPointReplyWraper()
	{
		 m_Result = -1;
	...
	public void ResetWraper()
	{
 	...
 	//转化成Protobuffer类型函数
	public BagRpcClearBagRedPointReply ToPB()
	{
		BagRpcClearBagRedPointReply v = new BagRpcClearBagRedPointReply();
		v.Result = m_Result;
	...
	//从Protobuffer类型初始化
	public void FromPB(BagRpcClearBagRedPointReply v)
	{
        if (v == null)
            return;
		m_Result = v.Result;
	...
	{
		MemoryStream protoMS = new MemoryStream();
		ProtoBuf.Serializer.Serialize<BagRpcClearBagRedPointReply>(protoMS, ToPB());
		return protoMS;
	}
	...
	public bool FromMemoryStream(MemoryStream protoMS)
	{
		BagRpcClearBagRedPointReply pb = ProtoBuf.Serializer.Deserialize<BagRpcClearBagRedPointReply>(protoMS);
		FromPB(pb);
		return true;
	}
